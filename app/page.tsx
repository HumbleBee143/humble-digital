  ...
  return (
    <>
      ...
      <section className="px-6 pt-20 pb-24 max-w-6xl mx-auto">
        ...
        {/* Decorative elements */}
        <div className="absolute right-0 top-16 w-1/3 h-[600px] opacity-[0.03] pointer-events-none hidden lg:block">
          <div className="w-full h-full border border-gold/30 rounded-l-full" />
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'Creating simple, modern websites tailored to your needs.',
              },
              {
                num: '02.',
                title: 'E-commerce Solutions',
                desc: 'Launch your online store seamlessly with our help.',
              },
              {
                num: '03.',
                title: 'SEO Services',
                desc: "Boost your website's search engine visibility effectively.",
              },
            ].map((s) => (
              <div
                key={s.num}
                className="service-card bg-dark-card border border-white/5 rounded-xl p-8 hover:border-gold/30"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: 'Affordability',
                desc: 'Affordable web design solutions tailored to fit your budget while maintaining quality and style.',
              },
              {
                title: 'Personal Touch',
                desc: 'Our hands-on approach ensures personalised service and support throughout your web design journey.',
              },
              {
                title: 'Simplicity',
                desc: 'We simplify the web design process, making it easy for you to take your ideas online.',
              },
            ].map((v) => (
            ...
            {[
              {
                step: 'Step-01',
                title: 'Consultation',
                desc: 'We start with a friendly consultation to understand your vision and goals.',
              },
              {
                step: 'Step-02',
                title: 'Design & Build',
                desc: 'Next, we create a tailored design that reflects your brand identity and meets your needs.',
              },
              {
                step: 'Step-03',
                title: 'Launch & Support',
                desc: 'Finally, we launch your website and provide ongoing support to ensure your success.',
              },
            ].map((p, i) => (
      ...
      <section
        ...
        style={{
          background: 'linear-gradient(135deg, #1a1a1a 0%, #1f1a0f 50%, #1a1a1a 100%)',
        }}
      >
        ...
        <div
          ...
          style={{
            backgroundImage: 'repeating-linear-gradient(90deg, rgba(201,147,58,0.3) 0px, transparent 1px, transparent 40px)',
          }}
        />
